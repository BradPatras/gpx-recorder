...
<p>Effective date: March 19, 2019</p>


<p>Brad Patras App Development ("us", "we", or "our") operates the  mobile application (hereinafter referred to as the "Service").</p>
...
<ul>
    <li>
        <p><strong>Service</strong></p>
                <p>Service is the  mobile application operated by Brad Patras App Development</p>
            </li>
    <li>
...
<p>Brad Patras App Development will take all the steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organisation or a country unless there are adequate controls in place including the security of your data and other personal information.</p>

<h2>Disclosure of Data</h2>


<h3>Legal Requirements</h3>
<p>Brad Patras App Development may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
<ul>
    <li>To comply with a legal obligation</li>
    <li>To protect and defend the rights or property of Brad Patras App Development</li>
